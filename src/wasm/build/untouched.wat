(module
 ...
 (export "add" (func $src/wasm/as/index/add))
 (export "factorial" (func $src/wasm/as/index/factorial))
 ...
 (func $src/wasm/as/index/add (; 14 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
 )
 (func $src/wasm/as/index/factorial (; 15 ;) (param $0 f64) (result f64)
  local.get $0
  f64.const 0
  f64.eq
  if (result i32)
  ...
  f64.convert_i32_s
  f64.sub
  call $src/wasm/as/index/factorial
  f64.mul
 )
